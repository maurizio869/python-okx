...
# Last modified (MSK): 2025-01-03 18:50 — правка номер 1
# Changes:
# - Добавлена поддержка отображения jump (синие) и drop (оранжевые) предсказаний
# - Обратная совместимость со старым форматом (только jump)
